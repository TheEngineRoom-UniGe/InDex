...
UDP_IP = "130.251.13.153"#113"#"192.168.43.94" #
UDP_PORT = 2390
debugPort = 2490

names = ["thumb_1","thumb_2","index_1","index_2","middle_1","middle_2","6","7","8","9","10","11","12","13","14","ring_1","ring_2","pinkie_1","pinkie_2","base_","wrist","hand2","cube"]
...
#			    continue
			...
			pub2.publish (msg2)
			#pub3 = rospy.Publisher("imu_data", Imu, queue_size=0)
			#pub3.publish(msg)
